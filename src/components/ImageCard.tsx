...
export const ImageCard: React.FC<ImageCardProps> =
 ({nome, dataUpload, src, tamanho, extension }: ImageCardProps) => {
    ...
    return (
        <div className="card relative bg-white rounded-md shadow-md transition-tranform ease-in duration-300 transform hover:shadow-lg hover:-translate-y- ">
            ...
            <div className="card-body p-4 ">
                ...
                <button onClick={download} className='bg-red-500 text-white px-2 py-1 rounded-lg text-sm mx-auto block hover:bg-red-300'>DOWNLOAD</button>
            </div>
        </div>
    )
}
